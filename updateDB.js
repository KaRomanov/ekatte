...
export async function insertMunicipalities(dbClient) {
    ...
    const sql = `INSERT INTO municipalities (id, name_bg, name_en, region_id, municipality_center_id)
        VALUES ($1, $2, $3, $4, $5)`;
...
export async function insertTownhalls(dbClient) {
    ...
    const sql = `INSERT INTO townhalls (id, name_bg, name_en, municipality_id, townhall_center_id)
        VALUES ($1, $2, $3, $4, $5);`;
...
export async function insertTowns(dbClient) {
    ...
    const sql = `INSERT INTO towns (id, type, name_bg, name_en, townhall_id, municipality_id)
        VALUES ($1, $2, $3, $4, $5, $6)`;
